...
void main() => runApp(Prog4());

class Prog4 extends StatelessWidget {
  final String title = 'Flexibility Training Progress Chhecklist';
...
class _MainPageState extends State<MainPage> {
  final allowNotifications = NotificationSetting(title: 'Flexibility Training Complete');
    ...
    body: ListView(
      children: [
        IconButton(
          ...
          iconSize: 30,
          color: Colors.white,
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context)=> Flexibility()))
        ),
